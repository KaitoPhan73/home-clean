...
export default function ManagerProfilePage() {
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gradient-to-b from-blue-50 to-white">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-6 text-blue-600 font-medium text-lg">Đang tải thông tin...</p>
          <p className="text-blue-400 text-sm mt-2">Vui lòng đợi trong giây lát</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-auto bg-gradient-to-b from-blue-50 to-white">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg">
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center space-x-2 bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg transition-all duration-300 text-sm shadow-md hover:shadow-lg">
              <Edit size={16} />
              <span>Chỉnh sửa</span>
            </button>
          </div>
      ...
      <div className={`bg-white shadow z-10 transition-all duration-300 ${scrollPosition > 100 ? 'sticky top-0 shadow-md' : ''}`}>
        <div className="container mx-auto px-4">
          <div className="flex overflow-x-auto hide-scrollbar">
            <button 
              className={`px-4 py-3 text-sm font-medium whitespace-nowrap flex items-center space-x-2 border-b-2 transition-all duration-300 ${activeTab === 'profile' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300'}`}
            ...
            <button 
              className={`px-4 py-3 text-sm font-medium whitespace-nowrap flex items-center space-x-2 border-b-2 transition-all duration-300 ${activeTab === 'team' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300'}`}
            ...
            <button 
              className={`px-4 py-3 text-sm font-medium whitespace-nowrap flex items-center space-x-2 border-b-2 transition-all duration-300 ${activeTab === 'activity' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300'}`}
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{manager.groupName ?? "Chưa phân nhóm"}</p>
                      </div>
                    </div>
                    <div className="flex items-start group">
                      <div className="p-2 rounded-lg bg-blue-50 text-blue-600 mr-3 group-hover:bg-blue-100 transition-all duration-300">
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-100 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="grid gap-3">
                      ...
                      <div className="flex items-center py-2 border-b border-gray-100 group hover:bg-blue-50/20 rounded-md px-2 transition-all duration-300">
                        ...
                        <p className="text-gray-500 text-sm w-1/3">Mã quản lý</p>
                      ...
                      <div className="flex items-center py-2 border-b border-gray-100 group hover:bg-blue-50/20 rounded-md px-2 transition-all duration-300">
                        ...
                        <p className="text-gray-500 text-sm w-1/3">Số điện thoại</p>
                        <p className="font-medium">{manager.phoneNumber}</p>
                      </div>
                      <div className="flex items-center py-2 border-b border-gray-100 group hover:bg-blue-50/20 rounded-md px-2 transition-all duration-300">
                        <div className="p-1.5 rounded-lg bg-blue-50 text-blue-600 mr-3 group-hover:bg-blue-100 transition-colors duration-300">
                        ...
                        <p className="text-gray-500 text-sm w-1/3">Trạng thái</p>
                        <div className="flex items-center">
                          <span className={`inline-block w-2 h-2 rounded-full mr-2 ${manager.status === 'Active' ? 'bg-green-500' : 'bg-red-500'}`}></span>
                          <p className="font-medium">{manager.status ?? "N/A"}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-100 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="grid gap-3">
                      ...
                      <div className="flex items-center py-2 border-b border-gray-100 group hover:bg-blue-50/20 rounded-md px-2 transition-all duration-300">
                        ...
                        <p className="font-medium break-all">{manager.groupId ?? "Chưa có nhóm"}</p>
                      </div>
                      <div className="flex items-start py-2 group hover:bg-blue-50/20 rounded-md px-2 transition-all duration-300">
                        ...
                        <p className="text-gray-500 text-sm w-1/3 mt-0.5">Nhân viên</p>
                        <div className="flex-1">
                          ...
                          >
                            <span className="font-medium text-sm mr-1">Nhân viên ({manager.staffNames?.length ?? 0})</span>
                            {staffExpanded ? 
                            ...
                            <div className="bg-gray-50 rounded-lg p-3 mt-2 max-h-60 overflow-y-auto shadow-inner">
                              <ul className="space-y-2">
                                {manager.staffNames?.map((staff, index) => (
                                  <li key={index} className="flex items-center p-2 hover:bg-blue-50 rounded-lg transition-colors duration-300">
                                ...
                                )) || <li className="text-sm text-gray-500 p-2">Không có nhân viên</li>}
                              </ul>
                            </div>
                          )}
                        </div>
          ...
          {activeTab === 'team' && (
            <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {manager.staffNames?.map((staff, index) => (
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 transition-all duration-300 hover:shadow-lg hover:border-blue-200 hover:bg-blue-50/20 group">
                    <div className="flex items-center">
                  ...
                  <div className="col-span-3 flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-gray-500 mb-2">Chưa có nhân viên trong nhóm</p>
              ...
              <div className="space-y-4">
                <div className="flex group">
                  ...
                  <div className="ml-4 flex-1 p-3 rounded-lg group-hover:bg-blue-50/20 transition-all duration-300">
                    <p className="text-sm text-gray-500">{formattedDateTime(manager.updatedAt)}</p>
                    <p className="font-medium text-lg mt-1">Cập nhật thông tin cá nhân</p>
                    <p className="text-gray-600 mt-2">Thông tin cá nhân đã được cập nhật thành công</p>
                  </div>
                </div>
                ...
                <div className="flex group">
                  ...
                  <div className="ml-4 flex-1 p-3 rounded-lg group-hover:bg-green-50/20 transition-all duration-300">
                    <p className="text-sm text-gray-500">{formattedDateTime(manager.createdAt)}</p>
                    <p className="font-medium text-lg mt-1">Tạo tài khoản</p>
                    <p className="text-gray-600 mt-2">Tài khoản quản lý đã được tạo thành công</p>
                  </div>
                </div>
                ...
                <div className="flex group">
                  ...
                  <div className="ml-4 flex-1 p-3 rounded-lg group-hover:bg-blue-50/20 transition-all duration-300">
                    <p className="text-sm text-gray-500">{formattedDateTime(manager.createdAt)}</p>
                    <p className="font-medium text-lg mt-1">Được thêm vào nhóm</p>
                    <p className="text-gray-600 mt-2">Đã được thêm vào nhóm {manager.groupName ?? "Chưa phân nhóm"}</p>
                  </div>
                </div>
              </div>
            </div>
